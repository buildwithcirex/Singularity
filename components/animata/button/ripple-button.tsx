...
export default function RippleButton({ children, ...props }: RippleButtonProps) {
    ...
    return (
        <button
            ref={buttonRef}
            className="font-orbitron duration-[600ms] relative flex items-center justify-center overflow-hidden rounded-full bg-gold-500 p-[1.3rem] text-[1.2rem] font-medium text-black transition hover:text-white"
            onMouseEnter={(e) => {
